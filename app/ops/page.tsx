...
export default async function OpsPage() {
  ...
  return <main className="ops-shell">
    ...
    <section className="ops-main">
      ...
      <section className="ops-capacity" id="capacidad"><div><p className="section-kicker">Guardrail de 72 horas</p><h2>Chizpita recomienda. El equipo decide y compromete.</h2><p>Un pedido solo entra a producción cuando pago, brief aceptado y capacidad están confirmados. No vendemos urgencias falsas.</p></div><div><CheckCircle2 size={30} /><strong>8 Chizpas</strong><span>capacidad disponible hoy</span></div></section>
    </section>
  </main>;
}
