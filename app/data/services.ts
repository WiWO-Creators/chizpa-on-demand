...
const coreServices: ChizpaService[] = [
  {
    ...
    result: "Hasta 12 slides editables, listas para presentar", price: 143, hours: 72, revisions: 1, icon: "presentation",
  ...
  },
  {
    ...
    result: "Hasta 10 slides con narrativa, diseño y cierre", price: 155, hours: 72, revisions: 1, icon: "presentation",
  ...
  },
  {
    ...
    result: "Hasta 12 slides editables + notas para exponer", price: 71, hours: 72, revisions: 1, icon: "presentation",
  ...
  },
  {
    ...
    result: "Video de hasta 2 minutos listo para compartir", price: 107, hours: 72, revisions: 1, icon: "video",
  ...
  },
  {
    ...
    result: "1 video terminado + 2 formatos de salida", price: 95, hours: 72, revisions: 1, icon: "video",
  ...
  },
  {
    ...
    result: "Hasta 12 páginas editadas, diagramadas y listas", price: 83, hours: 72, revisions: 1, icon: "document",
  ...
  },
  {
    ...
    result: "Diagnóstico + edición de hasta 20 páginas + plan de avance", price: 95, hours: 72, revisions: 1, icon: "document",
  ...
  },
  {
    ...
    result: "1 diseño maestro + 2 adaptaciones listas para usar", price: 59, hours: 48, revisions: 1, icon: "palette",
  ...
  },
  {
    ...
    result: "Landing responsive de hasta 5 secciones publicada", price: 239, hours: 72, revisions: 1, icon: "palette",
  ...
  },
  {
    ...
    result: "1 trigger, hasta 3 acciones y 2 plataformas", price: 179, hours: 72, revisions: 1, icon: "workflow",
  ...
  },
  {
    ...
    result: "Herramienta web de una función, publicada y usable", price: 359, hours: 72, revisions: 1, icon: "workflow",
